  ...
  public function save_manufacture(Request $request)
	...
	public function unactive_manufacturey($manufacture_id)
    {
    	...
    	DB::table('tbl_manufacture')
    		...
    		Session::put('message','Manufacture inactive successful!!');
    ...
    public function active_manufacture($manufacture_id)
    {
    	...
    	DB::table('tbl_manufacture')
    		...
    		Session::put('message','Manufacture active successful!!');
   ...
   public function edit_manufacture($manufacture_id)
    {
     ...
     public function update_manufacture(Request $request,$manufacture_id)
     {
     	...
     	DB::table('tbl_manufacture')
     		...
     		Session::get('message','Manufacture update successful !');
     		return Redirect::to('/all-manufacture');
     ...
     public function delete_manufacture($manufacture_id)
     {
     	...
     	DB::table('tbl_manufacture')
     		...
     		Session::get('message','Manufacture deleted successful !');
     		return Redirect::to('/all-manufacture');
