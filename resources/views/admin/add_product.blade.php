						...
						<form class="form-horizontal" action="{{url('/save-product')}}" method="post" enctype="multipart/form-data">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge"name="product_price" id="date01" >
							  </div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="product_size" id="date01" >
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Product color</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" name="product_color" id="date01" >
							  </div>
							</div>
							<div class="control-group hidden-phone">
